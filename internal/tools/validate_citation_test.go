...
func TestParseCitation(t *testing.T) {
	tests := []struct {
		...
		{name: "hungarian full", citation: "2011. évi CXII. törvény 3. §", documentRef: "2011. évi CXII. törvény", sectionRef: "3", structured: true},
		{name: "hungarian full with colon", citation: "2013. évi V. törvény 6:272. §", documentRef: "2013. évi V. törvény", sectionRef: "6:272", structured: true},
		{name: "hungarian full with slash", citation: "2012. évi I. törvény 116/A. §", documentRef: "2012. évi I. törvény", sectionRef: "116/A", structured: true},
		{name: "hungarian doc only", citation: "2012. évi I. törvény", documentRef: "2012. évi I. törvény", structured: true},
		{name: "db id with section", citation: "hu-law-2012-1-00-00 s116", documentRef: "hu-law-2012-1-00-00", sectionRef: "116", structured: true},
		{name: "db id with colon section", citation: "hu-law-2013-5-00-00 s6:272", documentRef: "hu-law-2013-5-00-00", sectionRef: "6:272", structured: true},
...
func TestValidateCitationStatusWarnings(t *testing.T) {
	...
	out, err = runValidateCitationJSON(t, db, `{"citation": "Repealed Act"}`)
	if err != nil {
		t.Fatal(err)
	}
